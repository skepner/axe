...
namespace axe {
    ...
    public:
        explicit r_char_t(CharT aT) : t(aT) {}
    ...
    public:
        explicit r_bin_t(T&& aT) : t(std::forward<T>(aT)) {}
    ...
    class r_range_t AXE_RULE
    {
       Iterator begin, end;
    public:
        r_range_t(Iterator aBegin, Iterator aEnd): begin(aBegin), end(aEnd) {}
