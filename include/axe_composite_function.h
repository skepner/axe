...
namespace axe {
    ...
    >
            r_many (R&& r, S&& s, size_t min_occurrence = 1, size_t max_occurrence = static_cast<size_t>(-1))
    {
    ...
    namespace detail {
        ...
        {
            std::locale loc;
            toupper(std::locale aLoc) : loc(std::move(aLoc)) {}
        ...
        {
            std::locale loc;
            tolower(std::locale aLoc) : loc(std::move(aLoc)) {}
